...
function createMockPlayerResult(overrides: Partial<PlayerResult> = {}): PlayerResult {
  return {
    ...
    tournament: {
      ...
      locationId: 'loc-1',
      location: { id: 'loc-1', externalId: null, name: 'Test City', address: null, city: null, state: null, country: null, createdAt: '2024-01-01', updatedAt: '2024-01-01' },
      eventBooster: 'NONE',
    },
    ...overrides,
  };
    ...
    const results: PlayerResult[] = [
      createMockPlayerResult({
        ...
        tournament: {
          ...
          locationId: 'loc-lv',
          location: { id: 'loc-lv', externalId: null, name: 'Las Vegas', address: null, city: null, state: null, country: null, createdAt: '2024-01-01', updatedAt: '2024-01-01' },
          eventBooster: 'MAJOR',
        },
      }),
      createMockPlayerResult({
        ...
        tournament: {
          ...
          locationId: 'loc-pdx',
          location: { id: 'loc-pdx', externalId: null, name: 'Portland', address: null, city: null, state: null, country: null, createdAt: '2024-01-01', updatedAt: '2024-01-01' },
          eventBooster: 'NONE',
        },
      }),
    ];
